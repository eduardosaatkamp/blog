    ...
    <div class="row">
      ...
      <div class="col-lg-12">
        ...
        <div class="d-flex justify-content-between ">
          <h4>Edit Post</h4>
          <a class="btn btn-warning" href="<?php echo base_url('index.php/post/'); ?>"> <i class="fas fa-angle-left"></i>
           Back
          </a>

        <form method="post" action="<?php echo base_url('index.php/post/update/' . $data->id); ?>">
